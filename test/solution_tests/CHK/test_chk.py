...
class TestChk():
    ...
    def test_singleItemOffer(self):
        offerContents = {'A': 1}
        offerPrice = 10
        offer = chk.MultiPriceOffer(offerContents, offerPrice, TEST_PRICES)
    ...
    def test_multipleOffers(self):
        of1 = chk.MultiPriceOffer({'A': 1}, 10, TEST_PRICES)
        of2 = chk.MultiPriceOffer({'B': 1}, 10, TEST_PRICES)
    ...
    def test_multipleCompetingOffers(self):
        of1 = chk.MultiPriceOffer({'A': 1}, 20, TEST_PRICES)
        of2 = chk.MultiPriceOffer({'A': 4}, 60, TEST_PRICES)
    ...
    def test_two_e_one_b_free(self):
        offer = chk.MultiPriceOffer({'E': 2, 'B': 1}, chk.getTotalPrice({'E': 2}), TEST_PRICES)
    ...
    def test_two_f_get_one_f_free(self):
        offer = chk.MultiPriceOffer({'F': 3}, chk.getTotalPrice({'F': 2}), TEST_PRICES)
    ...
    def test_groupDiscountAndMultiBuy(self):
        ...
        of2 = chk.MultiPriceOffer({'A': 1, 'B': 1, 'C': 1}, 30, TEST_PRICES)
